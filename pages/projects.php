<section class="left wide">
	<figure>
		<!-- 709 x 473  -->
		<figure>
			<img src="img/elements/drawing.png" title="sketch" class="big_img"/>
			<figcaption class="right">
				<p class="left">Resort Runway</p>
			</figcaption>
		</figure>
		<nav class="img_nav right">
			<div class="left arrow" id="l_image_nav"></div> 
			<p class="left">Image X of X </p>
			<div class="right arrow" id="r_image_nav"></div>
		</nav>
	</figure>
</section>
